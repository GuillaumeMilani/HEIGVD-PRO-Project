...
\par
D'autres outils plus simples, comme la symétrie horizontale ou verticale, ou les effets de couleurs sont implémentés en ajoutant un action à des éléments de bases de JavaFX comme des Button ou des Slider.
