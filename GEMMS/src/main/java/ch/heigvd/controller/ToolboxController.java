...
public class ToolboxController {
   ...
   public void init(MainController mainController, ToolbarController toolbarController) {
   ...
   /**
    * Action when clicked on new canvas button. Create a canvas and add it to
    * the current workspace's layer list
    *
    * @param e
    */
   @FXML
   ...
   private void newImageButtonAction(ActionEvent e) {
      Workspace w = mainController.getCurrentWorkspace();
      if (w != null) {
         ImportImageDialog dialog = new ImportImageDialog(mainController.getStage());
   ...
   /**
    * Action when clicked on brush button. Set the current tool with a brush
    * tool
    *
    * @param e
    */
   ...
   /**
    * Action when clicked on eraser button. Set the current tool with an eraser
    * tool
    *
    * @param e
    */
   ...
   /**
    * Action when clicked on eye dropper button. Set the current tool with an
    * eye dropper tool
    *
    * @param e
    */
   ...
   /**
    * Action when clicked on vertical symmetry button. Tranform all selected
    * layers with vertical symmetry
    *
    * @param e
    */
   @FXML
   ...
   /**
    * Action when clicked on rotate button. Set the current tool with a rotate
    * tool
    *
    * @param e
    */
   ...
   /**
    * Action when clicked on scale button. Set the current tool with a scale
    * tool
    *
    * @param e
    */
   ...
   /**
    * Action when clicked on selection button. Set the current tool with a
    * selection tool
    *
    * @param e
    */
