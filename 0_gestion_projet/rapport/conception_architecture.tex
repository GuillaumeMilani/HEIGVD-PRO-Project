...
Comme vous pouvez le voir sur la figure \ref{fig:arch_javafx}, JavaFX propose énormément de fonctionnalités, passant par la création d'interface à la modélisation d'objet 3D. Dans notre projet, nous allons utilisé les composants de base permettant de créer des interfaces simples. Nous utiliserons également du CSS proposé par JavaFX afin de mettre en forme l'interface.
