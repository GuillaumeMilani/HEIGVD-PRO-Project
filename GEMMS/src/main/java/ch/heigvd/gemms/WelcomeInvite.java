 ...
 * <h1>WelcomeInvite</h1>
 * 
 * Utility class to avoid styling many times the same elements. It create 
 * a styled VBox containing a label and a button. Its purposes is for example
 * to propose an action to the user.
 */
