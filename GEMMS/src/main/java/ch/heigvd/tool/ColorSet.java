...
/**
 * ColorSet is a class that represents the application color set. 
 * It is composed of two main ColorPack, which keep track of two colors 
 * that the application interface is currently using.
 * 
 * The class uses the singleton pattern to provide the unique instance
 * of ColorSet.
 * @author mathieu
 */
public class ColorSet {
   ...
   /**
    * Private intern class that represent a color being tracked. It manages 
    * a current color and defines controllers element to change its state.
    */
   private class ColorPack {
      ...
      /**
       * Get the ColorPack ColorPicker
       * Return the ColorPicker instance that manages the ColorPack
       */
