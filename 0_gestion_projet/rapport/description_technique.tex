...
Le redimensionnement utilise setScaleX() ou setScaleY() et sa classe identique est \texttt{Scale}. Les points de référence sont identiques à la rotation. Il existe d'autres transformations, mais nous n'allons pas les utiliser dans le cadre de ce projet.
